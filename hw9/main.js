...
//     console.log(item);
//     const {name,surname,age,info,photo}= simpsons
//
//     let div=document .createElement ('div');
//     div.classList.add('members');
//     let simpsonDiv=document.createElement ('div');
//     simpsonDiv.innerText =(`${item.name}--${item.surname}--${item.surname}--${item.info}--${item.surname}`);
...
//
//     let houreDiv=document.createElement('div');
//     titleDiv.innerText = (`${hourDuration}`);
//
//     let monthDiv=document.createElement('div');
//     titleDiv.innerText = (`${item.monthDuration}`);
//
//     mainDiv.append(titleDiv, houreDiv, monthDiv);
// }
...
//
// let mainDiv= document.createElement ('div');
// mainDiv.classList.add('wrap','collapse','beta');
...
//
// let p = document.createElement('p');
// p.innerText =  'I like  this';
// elem.add(p);
// document.body.add(elem);
//
//
//
// let div=document.createElement ('div');
